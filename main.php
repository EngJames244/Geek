            ...
            <div class="container">
              ...
              <div class="row">
                <div class="col-md-4 col-sm-12">
                  <h2> Recommend Me </h2>
                  <a href="online_Exam/index.php"><i class="fas fa-hands-helping fa-7x"></i></a>
                </div>
                  <div class="col-md-4 col-sm-12">
                  <h2> Explore Courses </h2>
                  <a href="courses.php"><i class="fas fa-play fa-7x"></i></a>
                </div>
                    <div class="col-md-4 col-sm-12">
                  <h2> Live Training </h2>
                  <a href="Online_exam/index.php"><i class="far fa-address-card fa-7x"></i></a>
                </div>
              </div>
            </div>
          </div>
